          ...
          {filteredProfessionals.length > 0 ? (
            filteredProfessionals.map((professional) => (
              ...
              >
                ...
                <div>
                  <span className="block font-medium">{professional.user.name}</span>
                  <span className="text-sm text-zinc-500">{professional.specialty}</span>
                </div>
              </div>
            ))
          ) : (
            <div className="px-4 py-2 text-zinc-500">Nenhum profissional encontrado</div>
          )}
        </div>
      )}
    </div>
